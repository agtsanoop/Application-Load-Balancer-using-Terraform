...
module "vpc" {
  ...
  source   = "git::git@github.com:agtsanoop/aws_vpc_module.git"
...
~~~sh
resource "aws_launch_configuration" "shoppinglc" {
  name          =  "${var.project}-1"
  image_id      =  var.image
...
<p align="center">
 <a href="https://www.linkedin.com/in/sanoop-agt"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white"/></a> 
